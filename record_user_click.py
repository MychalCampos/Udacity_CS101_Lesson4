# -*- coding: utf-8 -*-
"""
Created on Sat Jul 04 13:40:53 2015
...
# # Your solution: This works but instructor's solution better
# # see below
...
# Insturctor's solution better as it checks first if there are any
# urls corresponding to keyword and does not do anything otherwise
def record_user_click(index, keyword, url):
    urls = lookup(index, keyword)
    if urls:  # if there are any matching urls
        for entry in urls:
            if entry[0] == url:
                entry[1] = entry[1]+1
                

# # Your solution: This works but instructor's solution more efficient
# # see below
...
#                    new_item = False
#                    break
#            if new_item:  # if we have a new url
...
# Insturctor's solution is more efficient
def add_to_index(index, keyword, url):
